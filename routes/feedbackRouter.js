 ...
 *      tags:
 *          - Feedback Management
 *      summary: "Get all feedback fields for the authenticated user's company by companyId"
*      parameters:
 *       - name: companyId
 *         in: path
 ...
 *                              type: object
 */
router.get('/Allfields', feedbackController.getFeedbackFieldsByCompany);
